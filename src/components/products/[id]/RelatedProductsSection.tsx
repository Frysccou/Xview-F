		...
		<div className="mb-12 relative px-4 sm:px-8 md:px-12 lg:px-16">
			...
			{loading ? (
				...
				<>
					...
					>
						<ChevronLeft size={36} className={currentIndex === 0 ? "opacity-50" : ""} />
					</button>
					...
					>
						<ChevronRight size={36} className={currentIndex === products.length - 1 ? "opacity-50" : ""} />
					</button>
					...
					<div className="flex justify-center mt-4 gap-4 sm:hidden">
						<button 
							...
							disabled={currentIndex === 0}
						>
							<ChevronLeft size={28} className={currentIndex === 0 ? "opacity-50" : ""} />
						</button>
						<button 
							onClick={() => scroll("right")} 
							...
							disabled={currentIndex === products.length - 1}
						>
							<ChevronRight size={28} className={currentIndex === products.length - 1 ? "opacity-50" : ""} />
						</button>
					</div>
				</>
			)}
